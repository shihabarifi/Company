;(function (global, factory) {
   ...
   factory(global.moment)
    ...
    moment.defineLocale('es-do', {
        ...
        weekdays : 'Companygo_lunes_martes_miércoles_jueves_viernes_sábado'.split('_'),
    ...
    moment.defineLocale('gl', {
        ...
        monthsParseExact: true,
        weekdays : 'Companygo_luns_martes_mércores_xoves_venres_sábado'.split('_'),
    ...
    moment.defineLocale('pt-br', {
        ...
        weekdays : 'Companygo_Segunda-feira_Terça-feira_Quarta-feira_Quinta-feira_Sexta-feira_Sábado'.split('_'),
    ...
    moment.defineLocale('tet', {
        ...
        monthsShort : 'Jan_Fev_Mar_Abr_Mai_Jun_Jul_Ago_Set_Out_Nov_Dez'.split('_'),
        weekdays : 'Companygu_Segunda_Tersa_Kuarta_Kinta_Sesta_Sabadu'.split('_'),
